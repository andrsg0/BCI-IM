...
const HELP: HelpContent = {
  ...
  points: [
    ...
    { label: 'Se entrena antes; en vivo solo se aplica', desc: 'Los filtros W del CSP y la frontera del LDA se aprendieron una sola vez, offline, con datos etiquetados (es lo que se ve fijo en la sección «El Modelo»). En vivo no se reaprende nada: el CSP es una multiplicación de matrices y el LDA un producto escalar, ambos instantáneos y causales. Por eso la nube de fondo está quieta y solo el punto de la ventana actual se mueve.' },
